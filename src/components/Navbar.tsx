...
export default function Navbar() {
  return (
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[96%] max-w-7xl bg-white/15 backdrop-blur-xl border border-white/30 rounded-2xl px-8 py-4 shadow-2xl flex items-center justify-between mx-auto transition-all ">
